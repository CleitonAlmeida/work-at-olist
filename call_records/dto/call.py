...
class CallDto(object):
    ...
    def __init__(self, namespace):
        ...
        self.call = self.ns.model('call', {
            ...
            'destination_number': fields.String(
                description='Destination number of call'),
            'initial_timestamp': fields.DateTime(required=False,
                description='Initial Timestamp'),
            'end_timestamp': fields.DateTime(required=False,
        ...
        self.callResponses = self.ns.clone(
            'callResponses', standardResponseDtoModel, {})
